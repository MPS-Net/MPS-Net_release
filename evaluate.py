...
if __name__ == "__main__":
    ...
    if target_dataset == '3dpw':
        ...
        if cfg.TITLE == 'repr_table4_h36m_mpii3d_model':
            data_path = f'./data/preprocessed_data/{target_dataset}_{set}_25fps_nosmpl_db.pt'  # Table 4 [TCMR]
        elif cfg.TITLE == 'repr_table6_h36m_model':
            data_path = f'./data/preprocessed_data/{target_dataset}_{set}_front_25fps_tight_nosmpl_db.pt'  # Table 6 [TCMR]
